...
class EditSubmissionForm extends Component {
  ...
  validate = data => {
    const errors = {};
    if (!this.state.consultantName)
      errors.consultantName = "Please enter a consultant name";
    if (!this.state.skillset) errors.skillset = "Please enter a skillset";
    if (!this.state.location) errors.location = "Please enter a location";
    if (!this.state.billingRate)
      errors.billingRate = "Please enter a billing rate";
    if (!this.state.vendor) errors.vendor = "Please enter a vendor name";
    if (!this.state.client) errors.client = "Please enter a client name";
