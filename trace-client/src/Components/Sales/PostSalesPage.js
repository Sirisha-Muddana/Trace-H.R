...
class PostSalesPage extends Component {
    submit = (data) =>
        this.props.salesForm(data).then(() => this.props.history.push('/markettingSales'));

    render() {
        return (
            <div className="container h-100">
                <Divider hidden />
                <Header className="border-bottom pb-2 mb-3" textAlign='center' as='h2'>Add submission</Header>
