...
import {Table, Button, Dropdown, Header, Divider, Menu, Input} from 'semantic-ui-react';
    ...
    render() {
            ...
            tableHeader = (
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell textAlign='center'>Consultant Name</Table.HeaderCell>
                        ...
                        <Table.HeaderCell width={3} textAlign='center'>Action</Table.HeaderCell>
                    </Table.Row>
                </Table.Header>
            );
        const
            salesList = this.props.sales.map(sales => (
                ...
                <Table.Body key={sales._id}>
                    <Table.Row>
                        ...
                        <Table.Cell textAlign='center'><Dropdown placeholder='Status'
                                                                 fluid
                                                                 selection
                                                                 options={feedback}
                        /></Table.Cell>
        ...
        return (
            ...
            <div>
                ...
                <Divider hidden/>
                <Header textAlign='center' as='h1'>Marketting Sales</Header>
                <Menu borderless>
                    <Menu.Item>
                        <Button as={Link} to='/newSales' primary>Add new entry</Button>
                    </Menu.Item>
